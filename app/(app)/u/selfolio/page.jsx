...
import { BookOpenCheck, BriefcaseBusiness, Globe, GraduationCap, User } from "lucide-react";
...
const forms = [
  ...
  { form: "Experience", pos: 3, component: <Experience />, icon: <BriefcaseBusiness /> },
  { form: "Certificate", pos: 4, component: <Certificate />, icon: <BookOpenCheck /> },
