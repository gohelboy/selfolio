...
const Contact = () => {
    return (
        <motion.section
            className='flex w-full md:max-w-[1140px] 2xl:max-w-[1440px] my-20 2xl:my-40'>
            <div className='flex md:h-[500px] 2xl:h-[600px] rounded-3xl flex-col gap-14 w-full bg-gradient-to-t from-[#0f0f0f] to-[#454545] text-white md:p-6 2xl:p-8'>
                <div className='grid grid-cols-2 h-full gap-2'>
                    <div className='flex flex-col justify-between '>
                        <div className='flex flex-col gap-2'>
                            <div className='flex items-center gap-2'>
                                <h2 className='md:text-4xl 2xl:text-6xl font-black'>CONNECT WIH ME</h2>
                                <Play className='md:size-8 2xl:size-12 fill-white' />
                            </div>
                            <div className='flex items-center gap-1'>
                                <GitCommitVertical className='md:size-4 2xl:size-8' />
                                <span className='md:text-sm 2xl:text-lg'>Apt. 544 77942 Schuppe Shores, East Shalanda, NM 26509-5915</span>
                            </div>
                        </div>
